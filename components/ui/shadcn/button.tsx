...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "transition-colors bg-primary text-primary-foreground hover:bg-primary/90",
        destructive:
          "transition-colors bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline:
          "transition-colors border border-input bg-background hover:bg-accent hover:text-accent-foreground",
        secondary:
          "transition-colors bg-secondary text-secondary-foreground hover:bg-secondary/80",
        ...
        highlighted: "btn-gradient",
        outlineHighlighted: "btn-outHlt",
      },
      size: {
